...
def index():
    ...
    top_category = pd.crosstab(index=df2['Category'], 
            ...
            aggfunc='count').sort_values(by = 'jumlah', ascending = False).head(10).reset_index()
    ...
    cat_order = pd.crosstab(index=df2['Category'], 
            columns='Total', 
            values=playstore['Category'],
            aggfunc='count').sort_values(by = 'Total', ascending = False).head(5).reset_index()
    ...
    top_install = pd.crosstab(index=playstore['Category'], 
            columns='jumlah', 
            values=playstore['Installs'],
            aggfunc='sum').sort_values(by = 'jumlah', ascending = False).head(5).reset_index()
    # Buatlah sebuah histogram yang menggambarkan distribusi Jumlah aplikasi yang diinstal berdasarkan kategori 
    # Histogram yang terbentuk terbagi menjadi 100 bins
